...
*the spread of the data of every distribution tend towards normality as
...
estimating varience using a t-test:
...
*Using a t-test, variance must be estimated from the sample and the
means of the data can be assumed to follow a normal distribution, I
found a test statistics of t~7~=-.22. This corresponds to a p-value of
0.83. This p-value is \>.05, so I fail to reject the null hypothesis
that the mean undulation rate is 1.4 Hz.*
...
we can reject the null hypothesis that males training at the AIS have
